<template>
  	<div>
        ...
        <div class="share_code">
            <header class="share_header">关注我哦，获取更多。</header>
            <img src="../../static/img/code.png" height="212" width="212" class="code_img"> 
        </div>
        <div class="share_cover" v-show="showHide" @click="showCover">
            <img src="../../static/img/5-2.png" class="share_img">
        </div>
  	</div>
</template>
...
<style scoped>
    ...
    .your_scores_container{
        width: 9.7rem;
        height: 9.1rem;
        background: url(../../static/img/4-2.png) no-repeat;
    ...
    .share_button{
        ...
        background: url(../../static/img/4-3.png) no-repeat 0.4rem 0;
    ...
    .share_cover{
        ...
        top: 0;
        left: 0;
        background: url(../../static/img/5-1.png) no-repeat;
        background-size: 100% 100%;
        opacity: 0.92;
    }
    .share_img{
